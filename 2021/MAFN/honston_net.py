...
def model():
    input_1 = Input(shape=(3, 3, 144))
    input_2 = Input(shape=(25, 25, chn))
    ...
    CAB_conv6 = Conv1D(48, (32), padding='same', strides=(1), kernel_initializer='glorot_uniform', use_bias=False)(
        CAB_reshape)
    CAB_bn6 = BatchNormalization()(CAB_conv6)
    CAB_relu6 = PReLU()(CAB_bn6)

    CAB_conv7 = Conv1D(144, (48), padding='same', strides=(1), kernel_initializer='glorot_uniform', use_bias=False)(
        CAB_relu6)
    ...
    conv_spe6 = Conv3D(8, (1, 1, 69), padding='valid', strides=(1, 1, 1))(add_all_spe)
    ...
    conv_spa1 = Conv3D(16, (5, 5, chn), padding='valid', strides=(1, 1, 1))(input_spa)
    ...
    # SAM
    VIS_conv1 = Conv3D(16, (1, 1, 16), padding='valid', strides=(1, 1, 1),kernel_initializer='glorot_uniform')(relu_spa11)
    ...
    VIS_conv2 = Conv3D(16, (1, 1, 16), padding='valid', strides=(1, 1, 1),kernel_initializer='glorot_uniform')(relu_spa11)
    ...
    VIS_conv3 = Conv3D(16, (1, 1, 16), padding='valid', strides=(1, 1, 1),kernel_initializer='glorot_uniform')(relu_spa11)
    ...
    VIS_SHAPEall = Reshape((21, 21, 16, 1))(VIS_mul2)

    VIS_conv4 = Conv3D(16, (16, 1, 1), padding='same', strides=(1),kernel_initializer='glorot_uniform')(VIS_SHAPEall)
    ...
    conv_spa71 = Conv3D(num_filters_spa, (3, 3, 1), padding='valid', strides=(1, 1, 1))(relu_spa7)
    bn_spa71 = BatchNormalization()(conv_spa71)
    relu_spa71 = PReLU()(bn_spa71)

    conv_spa8 = Conv3D(num_filters_spa, (5, 5, 1), padding='valid', strides=(1, 1, 1))(relu_spa71)
    ...
    reshape_all = Reshape((feature_fusion._keras_shape[1], feature_fusion._keras_shape[2],
                           feature_fusion._keras_shape[4], feature_fusion._keras_shape[3]))(feature_fusion)
    ...
    VIS_conv11 = Conv3D(16, (1, 1, 16), padding='valid', strides=(1, 1, 1), kernel_initializer='glorot_uniform')(relu_all1)
    ...
    VIS_conv21 = Conv3D(16, (1, 1, 16), padding='valid', strides=(1, 1, 1), kernel_initializer='glorot_uniform')(relu_all1)
    ...
    VIS_conv31 = Conv3D(16, (1, 1, 16), padding='valid', strides=(1, 1, 1), kernel_initializer='glorot_uniform')(relu_all1)
    ...
    VIS_SHAPEall1 = Reshape((3, 3, 16, 1))(VIS_mul21)

    VIS_conv41 = Conv3D(16, (16, 1, 1), padding='same', strides=(1), kernel_initializer='glorot_uniform')(VIS_SHAPEall1)
