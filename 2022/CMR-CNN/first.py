...
class HybridSN(nn.Module):
    def __init__(self):
        ...
        self.conv3d_1 = nn.Sequential(
            nn.Conv3d(1, 8, kernel_size=(1, 1, 1), stride=(1, 1, 1), padding=0),
            nn.BatchNorm3d(8),
        ...
        self.conv3d_3 = nn.Sequential(
            nn.Conv3d(16, 32, kernel_size=(3, 1, 1), stride=(2, 2, 2), padding=0),
            nn.BatchNorm3d(32),
            nn.ReLU(inplace = True)
        )
        ...
        self.layer1 = RestNetBasicBlock(192, 128)
    ...
    def forward(self,x):
        ...
        # out_3 = self.cbam_3(out_3)

        #out_1 = out_3.reshape(out_3.shape[0], -1, 28, 28)
        out_1 = out_3.reshape(out_3.shape[0], -1, 14, 14)
