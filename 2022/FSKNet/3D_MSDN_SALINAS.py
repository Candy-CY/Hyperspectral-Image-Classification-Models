...
from Utils import zeroPadding, normalization, doPCA, modelStatsRecord, averageAccuracy, deformable_se_sep_SA,hybrid_in,ssrn_SS_IN,densenet_IN,cnn3_3D_IN
...
# 调用设计好的模型
def model_MSDNet():
    model_dense =cnn3_3D_IN .ResnetBuilder.build_resnet_8((1, img_rows, img_cols, img_channels),
                                                                    nb_classes)
...
VALIDATION_SPLIT = 0.6  # 20% for trainnig and 80% for validation and testing
# 0.9  5212
# 0.8  10833
# 0.7  16246
# 0.6  21660
...
for index_iter in range(ITER):
    ...
    best_weights_MSDNet_path = 'F:/transfer code/Tensorflow  Learning/SKNet/models-sa-3dcnn-17-415/sa_best_3D_MSDNet_' + str(
        index_iter + 1) + '.hdf5'
    ...
    # train_indices 27068     test_indices 27061
...
modelStatsRecord.outputStats(KAPPA_3D_MSDNet, OA_3D_MSDNet, AA_3D_MSDNet, ELEMENT_ACC_3D_MSDNet,
                             ...
                             'F:/transfer code/Tensorflow  Learning/SKNet/records-sa-3dcnn-17-415/IN_train_3D.txt',
                             'F:/transfer code/Tensorflow  Learning/SKNet/records-sa-3dcnn-17-415/IN_train_3D_element.txt')
