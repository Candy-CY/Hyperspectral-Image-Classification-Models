...
from Utils import zeroPadding, normalization, doPCA, modelStatsRecord, averageAccuracy, cnn_3D_IN, HSI_CNN_IN, \
    deformable_se_IN, deformable_se_res_IN, deformable_se_sep_IN, densenet_IN,ssrn_SS_IN,cnn3_3D_IN,hybrid_in
...
def model_HSICNNet():
    model = hybrid_in.ResnetBuilder.build_resnet_8((1, img_rows, img_cols, img_channels), nb_classes)
...
for index_iter in range(ITER):
    ...
    best_weights_HSICNNet_path = 'F:/transfer code/Tensorflow  Learning/SKNet/models-in-hy-23-514/Indian_best_3D_HSICNNet_' + str(
        index_iter + 1) + '.hdf5'
...
modelStatsRecord.outputStats_assess(KAPPA_3D_HSICNNet, OA_3D_HSICNNet, AA_3D_HSICNNet, ELEMENT_ACC_3D_HSICNNet,
                                    CATEGORY,
                                    'F:/transfer code/Tensorflow  Learning/SKNet/records-in-hy-23-514/IN_test_3D.txt',
                                    'F:/transfer code/Tensorflow  Learning/SKNet/records-in-hy-23-514/IN_test_element_3D.txt')
