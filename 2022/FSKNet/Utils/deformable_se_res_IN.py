...
class ResnetBuilder(object):
    ...
    def build(input_shape, num_outputs):
        ...
        conv1 = Conv3D(filters=8, kernel_size=(3, 3, 7), strides=(1, 1, 7), kernel_regularizer=regularizers.l2(0.01),
                       kernel_initializer='he_normal', use_bias=False, activation='relu')(input)
        conv1 = BatchNormalization()(conv1)
        conv2 = Conv3D(filters=16, kernel_size=(3, 3, 5), strides=(1, 1, 5), kernel_regularizer=regularizers.l2(0.01),
                       kernel_initializer='he_normal', use_bias=False, activation='relu')(conv1)
        conv2 = BatchNormalization()(conv2)
        conv3 = Conv3D(filters=32, kernel_size=(3, 3, 3), strides=(1, 1, 3), kernel_regularizer=regularizers.l2(0.01),
        ...
        l3 = Conv2D(64, (1, 1), padding='same', kernel_regularizer=regularizers.l2(0.01),
...
def main():
    model = ResnetBuilder.build_resnet_8((1, 21, 21, 200), 16)
