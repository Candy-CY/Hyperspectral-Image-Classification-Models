...
# @FileName : process_cls_disjoint_c_model.py
# @Project  : AMS-M2ESL (HSIC), IEEE TGRS

# for the UH data set, main processing file for SVM-RBF,
...
if __name__ == '__main__':
    ...
    for curr_seed in seed_list:
        ...
        x_train, y_train, x_test, y_gt = data_load_operate.generate_data_set_disjoint(data_reshape, gt_train_re,
                                                                                      gt_test_re, index)
