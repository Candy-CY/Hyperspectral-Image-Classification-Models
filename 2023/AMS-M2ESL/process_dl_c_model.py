...
# @FileName : process_dl_c_model.py
# @Project  : AMS-M2ESL (HSIC), IEEE TGRS

# for IP and UP data sets, main processing file for the compared dl-based models,
# including 1D-CNN, MCM-CNN, SSTN, SSSAN, SSAtt, A2S2KResNet, SSFTT, and ASPN
...
if __name__ == '__main__':
    ...
    for curr_seed in seed_list:
        ...
        train_iter, test_iter = data_load_operate.generate_iter(data_padded, data, height, width,
                                                                gt_reshape, index, patch_length,
                                                                batch_size,
                                                                model_type_flag,
                                                                model_3D_spa_flag, last_batch_flag, model_flag,
                                                                dr_channels, scales)

        # total_iter = data_load_operate.generate_iter_total(data_padded, data, height, width, gt_reshape, data_total_index,
        #                                                patch_length,
        #                                                batch_size, model_type_flag, model_3D_spa_flag, last_batch_flag,model_flag,
        #                                                dr_channels, scales)
