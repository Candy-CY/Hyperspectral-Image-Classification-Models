...
# https://github.com/weecology/DeepTreeAttention/blob/main/src/models/Hang2020.py
...
class spectral_attention(Module):
    ...
    def __init__(self, filters, classes):
        ...
        self.attention_conv1 = nn.Conv1d(in_channels=filters, out_channels=filters, kernel_size=kernel_size,
                                         padding=pad)
        self.attention_conv2 = nn.Conv1d(in_channels=filters, out_channels=filters, kernel_size=kernel_size,
                                         padding=pad)
