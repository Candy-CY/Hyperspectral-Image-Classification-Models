...
# Spectral–Spatial Feature Tokenization Transformer for Hyperspectral Image Classification, TGRS 2022
...
class SSFTTnet(nn.Module):
    def __init__(self, in_channels=1, num_classes=16, num_tokens=4, dim=64, depth=1, heads=8, mlp_dim=8, dropout=0.1, emb_dropout=0.1):
