...
# @FileName : process_dl_c_model_m_scale.py
# @Project  : AMS-M2ESL (HSIC), IEEE TGRS

# considering the multiscle feature representation of MCM-CNN
# the customized main processing file for this compared method on IP and UP data sets
...
if __name__ == '__main__':
    ...
    for curr_seed in seed_list:
        ...
        train_iter, test_iter = data_load_operate.generate_iter_ms(data, gt_reshape, index,
                                                                   batch_size,
