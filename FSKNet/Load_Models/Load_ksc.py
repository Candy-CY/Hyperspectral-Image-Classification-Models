...
from Utils import zeroPadding, normalization, doPCA, modelStatsRecord, averageAccuracy, cnn_3D_IN,deformable_se_sep_ksc
...
for index_iter in range(ITER):
    ...
    best_weights_MSDNet_path = 'F:/transfer code/Tensorflow  Learning/SKNet/models-ksc-19-712/ksc_best_3D_MSDNet_' + str(
        index_iter + 1) + '.hdf5'
