...
def acc_reports(y_test, y_pred_test):
    target_names = ['Scurb', 'Willow swamp', 'CP hammock', 'CP/OAK', 'Slash pine', 'Oak/Broadleaf', 'Hardwood swamp',
                    'Graminiod marsh', 'Spartina marsh', 'Catiail marsh', 'Salt marsh', 'Mud flats', 'Wake']
...
if __name__ == '__main__':
    ...
    net, device = train(train_loader, epochs=500)
    # 只保存模型参数
    ...
    Test_time = toc2 - tic2
    file_name = "./HSI_classification_report.txt"
