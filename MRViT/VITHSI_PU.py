...
class ViT(nn.Module):
    def __init__(self, *, in_channels=1, image_size, patch_size, num_classes, dim, depth, heads,
        ...
        self.conv2d_features = nn.Sequential(
            nn.Conv2d(in_channels=64 * 100, out_channels=64, kernel_size=(3, 3), padding=1),
            nn.BatchNorm2d(64),
            nn.ReLU(),
        )
        self.conv2d_features_1 = nn.Sequential(
            nn.Conv2d(in_channels=6464, out_channels=110, kernel_size=(3, 3), padding=1),
            nn.BatchNorm2d(110),
            nn.ReLU(),
        )
...
if __name__ == '__main__':
    ...
    Test_time = toc2 - tic2
    file_name = "./HSI_classification_PU_report.txt"
