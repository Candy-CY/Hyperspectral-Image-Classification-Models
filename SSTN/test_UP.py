...
SAVE_PATH3 = './pretrained_models/UP-' + str(args.model) + '/' + str(args.model)  + '_sample200.pth' # args.save + '/' + str(args.model) + '_sample' + str(args.sample) + '.pth' 
...
trained_net.load_state_dict(torch.load(SAVE_PATH3, map_location='cuda:0'))
trained_net.eval()
...
plt.imshow(y_pred)
plt.axis('off')
fig_path = './Cmaps/UP-' + str(args.model) + '.png'
